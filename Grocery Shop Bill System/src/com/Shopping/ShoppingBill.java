...
public class ShoppingBill {
	public static void main(String args[]) {
		...
		System.out.println("\t\t\t\t\t " + "  " + "New Balaji Supermarket");
		System.out.println("\t\t\t\t\t31/1 Chanakya Nagar, Nashik");
		System.out.println("\t\t\t\t\t" + "    " + "Opposite Maruti Mandir");
		System.out.println("GSTIN: 02ABSPP8789W594" + "\t\t\t\t\t\t\tContact: (+91) 7896541230");
		...
		}else if(overAllPrice<=500) {
			sgst = overAllPrice * 7 / 100;
		}else if(overAllPrice<=1000) {
			sgst = overAllPrice * 9 / 100;
		}else if(overAllPrice<=2000) {
			sgst = overAllPrice * 13 / 100;
		}else{
			sgst = overAllPrice * 25 / 100;
		}
		System.out.println("\n\t\t\t\t\t\t\t\t\t\t          SGST (%) " + sgst);
		if(overAllPrice<=150) {
			cgst = overAllPrice * 5 / 100;
		}else if(overAllPrice<=500) {
			cgst = overAllPrice * 7 / 100;
		}else if(overAllPrice<=1000) {
			cgst = overAllPrice * 9 / 100;
		}else if(overAllPrice<=2000) {
			cgst = overAllPrice * 13 / 100;
		}else{
			cgst = overAllPrice * 25 / 100;
		}
		System.out.println("\n\t\t\t\t\t\t\t\t\t\t          CGST (%) " + cgst);
